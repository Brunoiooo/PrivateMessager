...
export async function decryptWithSignal(
  ...
  try {
    ...
    if (errorMessage.includes('Message key not found') || errorMessage.includes('counter was repeated')) {
      console.warn('[Signal] Message counter already used (duplicate/retry)', {
